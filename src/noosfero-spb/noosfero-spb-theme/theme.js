...
(function($){
  ...
  function setEvents(){
    // Fade css
    $('.software-block-finality').css({'opacity':0, 'top':0});
    // End Fade CSS
    var software_block = $('.software-block');
    software_block.mouseover(show_finality);
    software_block.mouseout(hide_finality);
