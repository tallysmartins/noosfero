...
class DatabaseHelperTest < ActiveSupport::TestCase
  ...
  def setup
    dd1 = SoftwareCommunitiesPlugin::DatabaseDescription.create(:name => "Oracle")
    dd2 = SoftwareCommunitiesPlugin::DatabaseDescription.create!(:name => "MySQL")
  ...
  should "return an empty list" do
    empty_list = []
    assert_equal [], SoftwareCommunitiesPlugin::DatabaseHelper.list_database(empty_list)
  end
  ...
  should "have same information from the list passed as parameter" do
    list_compare = SoftwareCommunitiesPlugin::DatabaseHelper.list_database(@database_objects)
  ...
  should "return false if list_database are empty or null" do
    list_compare = []
    assert_equal false, SoftwareCommunitiesPlugin::DatabaseHelper.valid_list_database?(list_compare)
  end
