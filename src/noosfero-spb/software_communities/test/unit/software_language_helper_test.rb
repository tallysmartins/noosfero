...
class SoftwareLanguageHelperTest < ActiveSupport::TestCase
  ...
  def setup
    pl1 = SoftwareCommunitiesPlugin::ProgrammingLanguage.create(:name => "Python")
    pl2 = SoftwareCommunitiesPlugin::ProgrammingLanguage.create(:name => "Java")
  ...
  should "return an empty list" do
    empty_list = []
    assert_equal [], SoftwareCommunitiesPlugin::SoftwareLanguageHelper.list_language(empty_list)
  end
  ...
  should "have same information from the list passed as parameter" do
    list_compare = SoftwareCommunitiesPlugin::SoftwareLanguageHelper.list_language(@software_language_objects)
  ...
  should "return false if list_language are empty or null" do
    list_compare = []
    assert_equal false, SoftwareCommunitiesPlugin::SoftwareLanguageHelper.valid_list_language?(list_compare)
  end
