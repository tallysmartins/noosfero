class UpdateNamespaceTypes < ActiveRecord::Migration
  def up
    ...
    execute("UPDATE blocks SET type = 'SoftwareCommunitiesPlugin::StatisticsBlock' WHERE type = 'StatisticsBlock'")
  ...
  def down
    ...
    execute("UPDATE blocks SET type = 'StatisticsBlock' WHERE type = 'SoftwareCommunitiesPlugin::StatisticsBlock'")
