...
(function($){
  ...
  function set_use_report_content() {
    ...
    $('.community-average-rating-container .star-rate-text').html('Avaliação dos usuários:');
    $('.community-average-rating-container .rate-this-community a').html('Avalie o software');
